...
func (ref apiServerImpl) RegisterRoutes(
	...
	adminGroup.POST("/menu/:category/items", menuHandler.Create)
	adminGroup.PUT("/menu/:category/items/:id", menuHandler.Update)
	adminGroup.DELETE("/menu/:category/items/:id", menuHandler.Delete)
	adminGroup.PATCH("/menu/:category/items/:id/order", menuHandler.UpdateOrder)
